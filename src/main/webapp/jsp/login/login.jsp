	...
	<div id="container">
		...
		<div id="login-panel">
				...
				<form method="post"action="login.htm">
					<table>
						<tbody>
							<tr>
								<td class="attr">邮箱</td>
								<td><input class="text-2" type="text" name="email"
									id="account"></td>
							</tr>
							<tr>
								<td class="attr">密码</td>
								<td><input class="text-2" type="password" name="password"
									></td>
							</tr>
							<tr>
								<td class="attr"></td>
								<td><span><input type="checkbox" name="autoLogin"
										value="on" id="keepLoginon"> <label for="keepLoginon">保持登录</label></span>
								</td>
							</tr>
							<tr>
								<td class="attr"></td>
			...
			<div id="demoUsers" class="panel-foot">
				<span><font color="red">${note}</font></span> 
