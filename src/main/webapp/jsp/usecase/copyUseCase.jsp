...
<form method="post" enctype="multipart/form-data" id="dataform" class="ajaxForm" action="AddUseCase.htm">
  <table class="table-1"> 
    <caption>建用例</caption>
    <tbody><tr>
      ...
      <td>
        <select name="product" id="product" class="select-3">
			<option value="${userCase.module.project.projectId}" selected="selected">${userCase.module.project.name}</option>
    ...
    <tr>
      ...
      <td><input type="text" name="title" id="title" value="${userCase.title}" class="text-1"><span class="star"> * </span></td>
    </tr>  
    <tr>
      <th class="rowhead">前置条件</th>
      <td><textarea name="precondition" id="precondition" rows="4" class="text-1">${userCase.precondition}</textarea></td>
    </tr>  
    <tr>
