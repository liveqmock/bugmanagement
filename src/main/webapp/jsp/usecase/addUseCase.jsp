...
<body>
	...
	<div class="navbar" id="modulemenu">
		<ul>
			...
			<li class=" "><a href="usecase.htm" target="" id="submenubrowse">浏览用例</a></li>
...
<form method="post" enctype="multipart/form-data" id="dataform" class="ajaxForm" action="AddUseCase.htm">
  <table class="table-1"> 
    ...
    <tr>
      ...
      <td>
        <select name="product" id="product" class="select-3">
			<option value="${curProject.projectId}" selected="selected">${curProject.name}</option>
        ...
        <select name="module" id="module">
			...
			<a href="showModule.htm" target="_blank">维护模块</a>
        </span>
      </td>
    </tr>  
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="title" id="title" value="" class="text-1"><span class="star"> * </span></td>
    </tr>  
    <tr>
