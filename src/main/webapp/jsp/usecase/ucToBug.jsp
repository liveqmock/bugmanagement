...
<body>
	...
	<div id="wrap">
		<div class="outer" style="min-height: 714px;">
			...
			<form method="post" enctype="multipart/form-data" id="dataform"class="ajaxForm" action="addBugFromUC.htm">
				<input type="hidden" value="${uc.caseId}" name="usercaseId">
				<table class="table-1">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="title" id="title" value="${uc.title}"
						...
						<tr>
							...
							<td><textarea class="xheditors" id="activeContentRichEditor"
									...
									&lt;p&gt;[前置条件]&lt;/p&gt;${uc.precondition}&lt;p&gt;[步骤]&lt;/p&gt;
									<c:forEach items="${stepList}" var="stepList">
				${stepList.num}. 1 &nbsp;${stepList.content}&lt;br /&gt;</c:forEach>
				&lt;p&gt;
				[结果]&lt;/p&gt;&lt;p&gt;[期望]&lt;/p&gt;
				<c:forEach items="${stepList}" var="stepList">
				${stepList.num}. 1 &nbsp;${stepList.expect}&lt;br /&gt;</c:forEach>
	...
	<div id="footer">
		<div id="crumbs">
			<a href="http://test.demo.zentao.net/my/">禅道管理</a> &nbsp;<span
				class="icon-angle-right"></span><a
				href="http://test.demo.zentao.net/bug/">Bug</a> &nbsp;<span
				class="icon-angle-right"></span><a
				href="http://test.demo.zentao.net/bug-browse-36.html">B:bati测试</a>
