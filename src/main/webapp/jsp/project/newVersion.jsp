...
<form method='post' action="addVersion.htm" id='dataform'>
  <table class='table-1 fixed'> 
    <caption>创建版本</caption>
    <tr>
      <th class='rowhead'>项目</th>
      <td><select name='projectId' id='product' class='select-3'>
      	<c:forEach items="${comProjects }" var="project">
      		<c:choose>
      			<c:when test="${project.projectId eq curProject.projectId }">
