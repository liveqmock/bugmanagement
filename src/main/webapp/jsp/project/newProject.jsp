...
<form method='post' action="addProject.htm" method="post" id='dataform'>
  <table align='center' class='table-1 a-left'> 
    <caption>
      <div class='f-left'>添加项目</div>
    </caption> 
        <tr>
      <th class='rowhead'>项目名称</th>
      <td><input type='text' name='name' id='name' value='' class='text-3' />
</td>
    </tr>  
    <tr>
      <th class='rowhead'>开始日期</th>
      <td><input type='text' name='startDate' id='begin' value='' class='text-3 date' onchange='computeWorkDays()' />
</td>
    </tr>  
    <tr>
      <th class='rowhead'>结束日期</th>
      <td>
         <input type='text' name='endDate' id='end' value='' class='text-3 date' onchange='computeWorkDays()' />
      </td>
    </tr>
    <tr>
      <th class='rowhead'>项目目标</th>
      <td><textarea name='goal' id='goal' rows='6' class='area-1'></textarea>
</td>
    </tr>  
    <tr>
      <th class='rowhead'>项目描述</th>
      <td><textarea name='description' id='desc' rows='6' class='area-1'></textarea>
</td>
    </tr>    
    <tr>
...
&nbsp;<span class="icon-angle-right"></span>添加项目  </div>
  <div id="poweredby">
