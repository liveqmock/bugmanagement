...
<script language='Javascript'>page = "confirmbug"
</script>
<form method='post' target="theID" id="bugsheet"  >
  ...
  <table class='table-1'>
    ...
    <tr>
      ...
      <td>
      <select name='pri' id='pri' class="select-2">
