					...
					<tbody>
						<tr>
							...
							<td><select name="product" id="product"class="select-3"autocomplete="off">
								...
								</select><span class="star"> * </span> <a href="showModule.htm" target="_blank">模块维护
								</a></span></td>
						</tr>
						<tr>
							...
							<td><span id="buildBox"> <select name="version"
								...
								</select><span class="star"> * </span> <a href="newVersion.htm" target="_blank">创建发布
								</a></span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><textarea class="xheditors" id="activeContentRichEditor"
									name="chongxian" style="height: 200px; width: 61%;">&lt;p&gt;[步骤]&lt;/p&gt;&lt;p&gt;[结果]&lt;/p&gt;&lt;p&gt;[期望]&lt;/p&gt;</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td><select name="type" id="type" class="select-2">
									<option value="代码错误" selected="selected">代码错误</option>
